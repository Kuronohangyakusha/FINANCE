        ...
        <div class="flex flex-col lg:flex-row h-full">
            ...
            <div class="lg:w-1/2 p-8 overflow-y-auto">
                <div class="max-w-md mx-auto h-full flex flex-col justify-center">
                    ...
                    <!-- Formulaire -->
                    <form method="POST" action="/authenticate" class="space-y-8">
                        <!-- Téléphone -->
                        <div>
                            ...
                            <input type="tel" name="numero_tel" value="<?= old('numero_tel') ?>" 
                                   class="w-full px-4 py-4 border <?= errors('numero_tel') ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors text-lg" 
                        ...
                        <!-- Password -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-3">Mot de passe</label>
                            <div class="relative">
                                <input type="password" name="password" 
                                       class="w-full px-4 py-4 border <?= errors('password') ? 'border-red-500' : 'border-gray-300' ?> rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors text-lg pr-12" 
                        ...
                        <div class="text-center">
                            ...
                            <a href="/create" class="text-orange-500 hover:text-orange-600 font-medium">Créer un compte</a>
                        </div>
                    </form>
                </div>
            </div>
